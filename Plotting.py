...
class Plot:
    def __init__(self, path):
        ...
        self.rt60_high, self.rt60_mid, self.rt60_low, self.rt60_avg, self.rt60_diff = 0

    #Plots Waveform
    def wave_form(self):

        raw = wave.open(self.path)
    ...
    def reverb_high(self):
        ...
        def frequency_check():
            ...
            target_frequency = find_target_frequency(self.freq)
        ...
        rt20 = (self.t[index_of_max_less_5] - t[index_of_max_less_25])[0]
        ...
        print(f'The RT60 reverb time a freq {int(find_target_frequency(self.freq))}Hz is {round(abs(rt60), 2)} seconds')
